  ...
  const customerReviews = [
    {
      ...
      name: "Aisha M.",
      review:
        "Tabakhat has transformed my cooking! The recipes are incredibly easy to follow, and the results are always delicious. Highly recommended!",
      rating: 5,
    ...
    },
    {
      ...
      name: "Omar K.",
      review:
        "I've found so many authentic recipes here that remind me of home. The app is beautifully designed and very user-friendly.",
      rating: 5,
    ...
    },
    {
      ...
      name: "Fatima A.",
      review:
        "The variety of dishes is amazing, and I love the detailed instructions. It's my go-to app for Middle Eastern cuisine!",
      rating: 4,
    ...
    },
    {
      ...
      name: "Tariq S.",
      review:
        "A fantastic resource for anyone looking to explore new flavors. The 'Beef Recipes' section is particularly impressive.",
      rating: 5,
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                {beefRecipes.map((recipe) => (
                  <SwiperSlide
                    key={recipe.idMeal}
                    className="bg-white rounded-3xl shadow-lg overflow-hidden flex flex-col justify-between"
                  >
                    ...
                    <div className="p-6 flex flex-col flex-1 justify-between">
                      ...
                      >
                        {truncate(recipe.strMeal, 22)}
                      </h3>
                      <Link
                        href={`/recipesId/${recipe.idMeal}`}
            ...
            >
              <Card className="text-center p-6">
                ...
                <CardDescription className="text-gray-600">
                  Curated by professional chefs and food enthusiasts
                </CardDescription>
              </Card>
            </motion.div>
            <motion.div
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-1">
                        {[...Array(review.rating)].map((_, i) => (
                          <Star
                            key={i}
                            className="w-4 h-4 fill-[#FFE353] text-[#FFE353]"
                          />
                        ))}
                      </div>
                    </div>
