    ...
    <div className="min-h-screen bg-zinc-100 py-12 px-4">
      ...
      >
        ...
        <div className="w-full md:w-1/2 bg-zinc-900 p-8 flex flex-col justify-center">
          ...
          >
            <h1 className="text-4xl font-bold mb-2 text-amber-400">Get in Touch</h1>
          ...
          >
            ...
            >
              <svg className="w-5 h-5 mr-3 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-amber-500 transition ${
                      errors.email ? "border-amber-500" : "border-zinc-300 hover:border-amber-400"
                    }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-amber-500 transition ${
                      errors.phone ? "border-amber-500" : "border-zinc-300 hover:border-amber-400"
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-amber-500 transition ${
                    errors.subject ? "border-amber-500" : "border-zinc-300 hover:border-amber-400"
                  }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={200}
                  className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-amber-500 transition ${
                    errors.message ? "border-amber-500" : "border-zinc-300 hover:border-amber-400"
                  }`}
                  placeholder="Your message here..."
                />
                <div className="flex justify-between mt-1">
                  <span className={`text-xs ${form.message.length > 180 ? "text-amber-600" : "text-zinc-500"}`}>
